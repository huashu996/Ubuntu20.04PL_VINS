...
int main(int argc, char **argv) {
  ...
  m_camera = camodocal::CameraFactory::instance()->generateCameraFromYamlFile("/home/cxl/workspace/PL-VINS/src/PL-VINS/config/euroc/euroc_config_fix_extrinsic.yaml");
